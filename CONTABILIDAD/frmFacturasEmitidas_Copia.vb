...
Public Class frmFacturasEmitidas_Copia
    ...
    'Function NombreCliente(cliente As BDContabilidadGMELO.ClientesRow) As String

    '    Dim Nombre As String = ". " + cliente._Nombre_RazónSocial.TrimEnd
    '    Dim ape As String
    '    Try
    ...
    Private Sub GenerarToolStripButton_Click(sender As Object, e As EventArgs) Handles GenerarToolStripButton.Click
        ...
        For Each cliente As BDContabilidadGMELO.ClientesRow In Me.ClientesTableAdapter.ClientesActivosConFactura
            ...
            'Console.WriteLine(r.NomyApes)

            For Each facturaAnterior As BDContabilidadGMELO.FacturasEmitidasRow In Me.FacturasEmitidasTableAdapter.FacturasClienteMes(cliente.id, MesAnterior)

                'Console.WriteLine(f.FechaEmisión)
                ...
                With facturaAnterior
                    ...
                    factura.Número = CMódulo.NúmeroNuevaFactura(My.Settings.BDContabilidadConnectionString, FechaFactura.Year)
                    factura.FechaEmisión = FechaFactura
                    factura.FechaOperación = FechaFactura
                    factura.idCliente = facturaAnterior.idCliente
                    ...
                    Console.WriteLine(factura.NomCliente + ": " + factura.Número + " " + factura.FechaEmisión.ToShortDateString + " " + factura.FechaOperación.ToShortDateString)
                    ...
                    End With
                    ' celdas con datos
                    With oTable.Cell(3, 2).Range

                        .Text = "Servicio de limpieza en sus instalaciones durante el mes corriente"
                        .Font.Name = "Times New Roman"
                        .Font.Size = 12
                        .Font.Bold = CInt(False)
                        .ParagraphFormat.Alignment = Word.WdParagraphAlignment.wdAlignParagraphLeft
                    End With
                    With oTable.Cell(3, 4).Range

                        .Text = factura.BaseImponible.ToString("N2")
                        .Font.Size = 12
                        .Font.Bold = CInt(False)
    ...
    Private Sub PagarStripButton_Click(sender As Object, e As EventArgs) Handles PagarStripButton.Click
        ...
        ' Se genera asiento
        '       
        For Each f As BDContabilidadGMELO.FacturasEmitidasRow In Me.FacturasEmitidasTableAdapter.FacturasContabilizadasSinPagarSinBloquear
    ...
    Private Sub DuplicarFacturaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DuplicarFactura.Click
        ...
        Me.FacturasEmitidasTableAdapter.Insert(NúmeroFactura, Today, Today, idCliente, BaseImponible, TipoIVA, False, False, Today, 1, False)
    ...
    Private Sub GenerarLaFacturaSeleccionadaEnDocumentoWordToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GenerarLaFacturaSeleccionadaEnDocumentoWordToolStripMenuItem.Click
        ...
        With oTable.Cell(3, 4).Range
            ...
            .Text = BaseImponible.ToString("N2")
            .Font.Size = 12
            .Font.Bold = CInt(False)
            .ParagraphFormat.Alignment = Word.WdParagraphAlignment.wdAlignParagraphRight
