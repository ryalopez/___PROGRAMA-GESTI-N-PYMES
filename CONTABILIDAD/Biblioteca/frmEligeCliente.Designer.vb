...
Partial Class frmEligeCliente
    ...
    Private Sub InitializeComponent()
        ...
        Me.BDEmpresaDataSet = New Biblioteca.BDEmpresaDataSet()
        Me.ClientesTableAdapter = New Biblioteca.BDEmpresaDataSetTableAdapters.ClientesTableAdapter()
    ...
    Friend WithEvents BDEmpresaDataSet As Biblioteca.BDEmpresaDataSet
    Friend WithEvents ClientesTableAdapter As Biblioteca.BDEmpresaDataSetTableAdapters.ClientesTableAdapter
