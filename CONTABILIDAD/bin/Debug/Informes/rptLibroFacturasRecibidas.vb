...
Public Class rptLibroFacturasRecibidas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroFacturasRecibidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.rptLibroFacturasRecibidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_prmNombreEmpresa() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_prmEjercicio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptLibroFacturasRecibidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroFacturasRecibidas = New rptLibroFacturasRecibidas()
        rpt.Site = Me.Site
        Return rpt
    End Function
