...
<Browsable(True), Bindable(True, BindingDirection.TwoWay)>
Public Class CDatosDomicilio
    ...
    <Description("Tipo de propietario del domicilio"), Browsable(True), Category("Domicilio"), Bindable(True)>
    ...
    ''' <returns>Integer</returns>
    ''' <remarks>No puede ser nulo</remarks>
    <Description("Id de la entidad propietaria del domicilio: Cliente, Sucursal, Empleado, etc..."), Category("Domicilio"), Bindable(True)>
    ...
    <Description("Código de pais del domicilio"), Category("Domicilio"), Bindable(True), DefaultValue("ES")>
