...
Public Class rptFacturaCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.rptFacturaCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaCliente = New rptFacturaCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
